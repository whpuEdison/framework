...
!(function () {
  'use strict'
  function t (t, o) {
    return typeof t === 'string' ? (o || document).getElementById(t) : t || null
  }
  function o (t, o) {
  ...
  var s, i, p, n, r, c, l, h, a = 390, u = function (o, p) {
    ...
    typeof o === 'string' || typeof p === 'string') {
      s = {
        template: o,
        style: p || i.style
      }
  ...
  u.prototype.create = function (o) {
    ...
    this.opt.group && typeof this.opt.group === 'string' && this.pop.setAttribute('id', 'spop--' + this.opt.group),
  ...
  u.prototype.close = function () {
    this.opt.autoclose && typeof this.opt.autoclose === 'number' && (this.autocloseTimer = setTimeout(this.remove.bind(this, this.pop), this.opt.autoclose)),
  ...
  u.prototype.addListeners = function (t) {
    ...
    h === 'close' && (this.autocloseTimer && clearTimeout(this.autocloseTimer),
